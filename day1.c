       ...
       for(j=0;j<200;j++)
        {
            for(q=0;q<200;q++)
            {
                ...
                {
                    result= input[i]*input[j]*input[q];
